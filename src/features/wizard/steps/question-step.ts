import { getProgressBar } from '../components/progress-bar';
import { WIZARD_MODES } from '../wizard-config';
import { WizardState } from '../wizard-types';

type RenderWizardCallback = (container: HTMLElement) => void;

export function renderStep(container: HTMLElement, state: WizardState, renderWizardCallback: RenderWizardCallback) {
