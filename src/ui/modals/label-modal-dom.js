...
export function buildLabelModalHTML(label = null) {
    ...
    const config = {
        ...
        description: isEdit ? 'ラベルの名前を変更します。' : '新しいラベルを作成します。',
            ...
            <div class="bg-white dark:bg-gray-800 ${UI_STYLES.MODAL.WIDTH.DEFAULT} rounded-xl shadow-2xl overflow-hidden flex flex-col" role="dialog">
                ...
                <div class="flex justify-between items-center px-6 py-4 border-b border-gray-100 dark:border-gray-700">
                    <div class="flex items-center gap-3 w-full">
                        <div class="w-6 h-6 rounded-full flex-shrink-0" style="background-color: ${label?.color || '#3B82F6'}"></div>
                        <input type="text" id="modal-label-name" value="${config.title}" placeholder="${config.placeholder}"
