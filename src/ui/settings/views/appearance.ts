import { createRadioOption } from './components';
...
export function getAppearanceContent(currentTheme: string, currentBg: string, currentDensity: string | null, isCompact: boolean): string {
