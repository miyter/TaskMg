 ...
 * 言語設定のイベントハンドラ
 */
export function setupLanguageHandler(): void {
    const radios = document.querySelectorAll<HTMLInputElement>('input[name="ui_language"]');
...
function updateRadioStyles(radios: NodeListOf<HTMLInputElement>): void {
    radios.forEach(radio => {
