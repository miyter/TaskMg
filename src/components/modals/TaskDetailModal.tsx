        ...
        <Modal isOpen={isOpen} onClose={closeModal} className="max-w-4xl h-[85vh]">
            <div className="flex flex-col h-full">
                ...
                <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center gap-4 shrink-0">
                    ...
                    <button onClick={closeModal} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
