        ...
        <div className="fixed bottom-4 right-4 z-[9999] flex flex-col gap-2 pointer-events-none">
            {toasts.map((toast) => (
                <div
                    ...
                    className={cn(
                        "pointer-events-auto min-w-[300px] max-w-sm p-4 rounded-xl shadow border text-sm font-medium cursor-pointer hover:opacity-90",
                ...
                >
                    <div className="flex items-start gap-3">
                        ...
                        <p className="leading-5 flex-1">{toast.message}</p>
                        <button
