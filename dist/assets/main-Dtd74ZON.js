 ...
 */function Ek(n){n=le(n,Jt);const t=le(n.firestore,En);return sk(ia(t),n._key).then(e=>Mm(t,n,e))}class nu extends vk{constructor(t){super(),this.firestore=t}convertBytes(t){return new Ri(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Jt(this.firestore,null,e)}}function Ka(n){n=le(n,ti);const t=le(n.firestore,En),e=ia(t),i=new nu(t);return Sm(n._query),rk(e,n._query).then(s=>new Cm(t,i,n,s))}function iu(n,t,e,...i){n=le(n,Jt);const s=le(n.firestore,En),r=Yc(s);let o;return o=typeof(t=At(t))=="string"||t instanceof sa?pk(r,"updateDoc",n._key,t,e,i):gk(r,"updateDoc",n._key,t),ou(s,[o.toMutation(n._key,fe.exists(!0))])}function Dm(n){return ou(le(n.firestore,En),[new Tc(n._key,fe.none())])}function su(n,t){const e=le(n.firestore,En),i=ei(n),s=wk(n.converter,t);return ou(e,[fk(Yc(n.firestore),"addDoc",i._key,s,n.converter!==null,{}).toMutation(i._key,fe.exists(!1))]).then(()=>i)}function ru(n,...t){var e,i,s;n=At(n);let r={includeMetadataChanges:!1,source:"default"},o=0;typeof t[o]!="object"||zd(t[o])||(r=t[o],o++);const a={includeMetadataChanges:r.includeMetadataChanges,source:r.source};if(zd(t[o])){const d=t[o];t[o]=(e=d.next)===null||e===void 0?void 0:e.bind(d),t[o+1]=(i=d.error)===null||i===void 0?void 0:i.bind(d),t[o+2]=(s=d.complete)===null||s===void 0?void 0:s.bind(d)}let l,u,h;if(n instanceof Jt)u=le(n.firestore,En),h=qo(n._key.path),l={next:d=>{t[o]&&t[o](Mm(u,n,d))},error:t[o+1],complete:t[o+2]};else{const d=le(n,ti);u=le(d.firestore,En),h=d._query;const g=new nu(u);l={next:m=>{t[o]&&t[o](new Cm(u,g,d,m))},error:t[o+1],complete:t[o+2]},Sm(n._query)}return function(g,m,y,v){const w=new Hc(v),A=new zc(m,w,y);return g.asyncQueue.enqueueAndForget(async()=>Bc(await Po(g),A)),()=>{w.Za(),g.asyncQueue.enqueueAndForget(async()=>Uc(await Po(g),A))}}(ia(u),h,a,l)}function ou(n,t){return function(i,s){const r=new $e;return i.asyncQueue.enqueueAndForget(async()=>KE(await ik(i),s,r)),r.promise}(ia(n),t)}function Mm(n,t,e){const i=e.docs.get(t._key),s=new nu(n);return new Rm(n,s,t._key,i,new hs(e.hasPendingWrites,e.fromCache),t.converter)}(function(t,e=!0){(function(s){Ni=s})(Li),wi(new Wn("firestore",(i,{instanceIdentifier:s,options:r})=>{const o=i.getProvider("app").getImmediate(),a=new En(new Tw(i.getProvider("auth-internal")),new Rw(i.getProvider("app-check-internal")),function(u,h){if(!Object.prototype.hasOwnProperty.apply(u.options,["projectId"]))throw new U(O.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ms(u.options.projectId,h)}(o,s),o);return r=Object.assign({useFetchStreams:e},r),a._setSettings(r),a},"PUBLIC").setMultipleInstances(!0)),gn(rd,"4.7.3",t),gn(rd,"4.7.3","esm2017")})();Ew("debug");const Wd=window.GLOBAL_FIREBASE_CONFIG||{};let Ga,re,Ot,au=!1;if(Wd.apiKey)try{Ga=Rg(Wd),re=bw(Ga),Ot=lk(Ga),au=!0,console.log("Firebase initialized successfully.")}catch(n){console.error("Firebase initialization error:",n)}else console.error("Firebase config not found.");function it(n,t){const e=document.getElementById("message-modal");e&&e.remove();const i=`
    ...
    `).join("")}function Gk(n){var v,w;let t=n.dueDate;const e=((v=n.recurrence)==null?void 0:v.type)||"none",i=((w=n.recurrence)==null?void 0:w.days)||[];e!=="none"&&!t&&(t=lu({type:e,days:e==="weekly"?i:[]}));const s=t&&t.toDate?Gd(t.toDate()):t?Gd(new Date(t)):"",r=Kk(i),o=ni(),a=n.timeBlockId||"",l=o.map(A=>`<option value="${A.id}" ${A.id===a?"selected":""}>
            ${A.start} - ${A.end}
